...
//		System.out.println(url.getContent(classes));
	...
	public HashMap<String, String> getAuthToken(HashMap<String, String> data) {
		...
		try {
			...
			signature = apigeeAuthenticationService.getSignature(consumerKey, consumerSecret, callBackURL, timeStamp);
			String token = apigeeAuthenticationService.getAccessToken(accessTokenURL, consumerKey, consumerSecret,
	...
	@Step("Asset Merge operation using API " + GlobalConstants.TAG_TESTINGHUB)
