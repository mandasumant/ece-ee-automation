...
public class MOEOrderFlows extends ECETestBase {
  ...
  public void validateMoeOpportunityFlow() {
    HashMap<String, String> results = new HashMap<>();
    MOETestBase moetb = new MOETestBase(this.getTestBase(), testDataForEachMethod);
    //Create order using OpptyId for user not found scenario
    ...
    //Order is successfully placed in backend systems. Validate that the order origin for this order is GUAC_MOE_DIRECT
    //To do
