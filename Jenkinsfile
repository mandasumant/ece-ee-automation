...
def triggerApolloR2_0_5(def serviceBuildHelper, String env) {
    ...
    script {
        ...
        testingHubInputMap.testingHubApiPayload = '{"env":"' + env + '","executionid":"' + execution_id + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                ...
                '{"displayname":"MOAB - Reseller  Pay invoices Japan with ATM - Japan","testcasename":"26497eda","description":"MOAB - Reseller Pay invoices with ATM - Japan","testClass":"com.autodesk.ece.bic.testsuites.MOABOrder","testGroup":"moab-payinvoice","testMethod":"validateMOABPayInvoice","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16938"},"testdata":{"usertype":"new","password":"","payment":"ATM","store":"STORE-JP","purchaserEmail":"Reseller_JP_DCLE_zLGQXO@letscheck.pw","csn":"5500971276","sku":"default:1","email":"","locale":"ja_JP"}}' +
                '],"workstreamname":"dclecjt"}'
