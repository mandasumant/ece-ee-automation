          ...
          steps {
              ...
              script {
                  ...
                  testingHubInputMap.testingHubApiPayload = '{"env":"STG","executionname":"Appolo UAT - GUAC Orders","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                                                              ...
                                                              '{"displayname":"BiC Native Order Belgium(en_BE)","testcasename":"validateBicNativeOrder","description":"BiC Native Order BE(en_BE)","os":"windows","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-nativeorder","testMethod":"validateBicNativeOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CREDITCARD","store":"STORE-EU","sku":"default:1","email":"","locale":"en_BE"},"notsupportedenv":[],"wiki":""},' +
                                                              ...
                                                              '{"displayname":"BiC Native Order Iceland(en_IS)","testcasename":"validateBicNativeOrder","description":"BiC Native Order IS(en_IS)","os":"windows","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-nativeorder","testMethod":"validateBicNativeOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CREDITCARD","store":"STORE-CZ","sku":"default:1","email":"","locale":"en_IS"},"notsupportedenv":[],"wiki":""},' +
