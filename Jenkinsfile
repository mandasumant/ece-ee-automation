...
def triggerApolloR2_0_5(def serviceBuildHelper, String env) {
    ...
    script {
        ...
        testingHubInputMap.testingHubApiPayload = '{"env":" ' + env + ' ","executionname":"Apollo: Apollo R2.0.5 Japan orders on ' + env + '","notificationemail":["ece.dcle.platform.automation@autodesk.com","piyush.laddha@autodesk.com","Satish.Jupalli@autodesk.com","keshav.prasad.kuruva@autodesk.com","Ameko.Chen@autodesk.com","pavan.venkatesh.malyala@autodesk.com","ramanathan.kasiviswanathan@autodesk.com","arivuchelvan.pandian@autodesk.com","roshan.nampeli@autodesk.com","Joe.Mcqueeney@autodesk.com","tanner.hirakida@autodesk.com","vishal.kaul@autodesk.com","jeong.sohn@autodesk.com","cherry.ngo@autodesk.com"],"jiraTestCycleId":"30458","jiraPAT":"' + params.JIRAPAT + '","testcases":[' +
                '{"displayname":"GUAC - BiC Native Order JP CC","testcasename":"validateBicNativeOrder","description":"GUAC - BiC Native Order JP CC","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-nativeorder","testMethod":"validateBicNativeOrder","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16011"},"testdata":{"usertype":"new","password":"","payment":"CREDITCARD","store":"STORE-JP","locale":"ja_JP","sku":"default:1","email":"","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111"}},' +
                '{"displayname":"GUAC - BiC Native Order JP PAYPAL","testcasename":"validateBicNativeOrder","description":"GUAC - BiC Native Order JP PAYPAL","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-nativeorder","testMethod":"validateBicNativeOrder","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16012"},"testdata":{"usertype":"new","password":"","payment":"PAYPAL","store":"STORE-JP","locale":"ja_JP","sku":"default:1","email":"","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111"}},' +
                '{"displayname":"GUAC - MOE order JP CC","testcasename":"validateBicNativeOrderMoe","description":"MOE order JP CC","testClass":"com.autodesk.ece.bic.testsuites.MOEOrderFlows","testGroup":"bic-nativeorder-moe","testMethod":"validateBicNativeOrderMoe","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16013"},"testdata":{"usertype":"new","password":"","payment":"CREDITCARD","store":"STORE-JP","locale":"ja_JP","sku":"default:1","email":"","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111","timezone":"Japan/Tokyo"}},' +
                '{"displayname":"GUAC - MOE order JP Konbini","testcasename":"validateBicNativeOrderMoe","description":"MOE order JP Konbini","testClass":"com.autodesk.ece.bic.testsuites.MOEOrderFlows","testGroup":"bic-nativeorder-moe","testMethod":"validateBicNativeOrderMoe","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16013"},"testdata":{"usertype":"new","password":"","payment":"KONBINI","store":"STORE-JP","locale":"ja_JP","store_type":"FAMILY_MART","sku":"default:1","email":"","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111","timezone":"Japan/Tokyo"}}' +
                '],"workstreamname":"dclecjt"}'
    ...
    script {
        ...
        testingHubInputMap.authToken = serviceBuildHelper.ambassadorService.getForgeAuthToken(authInputMap)
        testingHubInputMap.testingHubApiEndpoint = 'https://api.testinghub.autodesk.com/hosting/v1/project/flex/testcase'
        testingHubInputMap.testingHubApiPayload = '{"env":" ' + env + ' ","executionid":"' + execution_id + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"jiraTestCycleId":"30458","jiraPAT":"' + params.JIRAPAT + '","testcases":[' +
                ...
                '{"displayname":"MOE O2P Order JP - Customer - Existing","testcasename":"97993340","description":"MOE O2P Order JP - Customer - Existing","testClass":"com.autodesk.ece.bic.testsuites.MOEOrderFlows","testGroup":"bic-basicFlowOdmCustomer-moe","testMethod":"validateMoeOdmOpportunityFlowCustomer","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16023"},"testdata":{"usertype":"existing","password":"","payment":"CREDITCARD","store":"STORE-JP","sku":"default:1","email":"","sapValidation":"' + params.INVOICE_VALIDATION + '","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111","locale":"ja_JP"}},' +
                '{"displayname":"MOE O2P Order JP - Customer - Existing - Konbini","testcasename":"97993340","description":"MOE O2P Order JP - Customer - Existing - Konbini","testClass":"com.autodesk.ece.bic.testsuites.MOEOrderFlows","testGroup":"bic-basicFlowOdmCustomer-moe","testMethod":"validateMoeOdmOpportunityFlowCustomer","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16023"},"testdata":{"usertype":"existing","password":"","payment":"KONBINI","store":"STORE-JP","store_type":"FAMILY_MART","sku":"default:1","email":"","sapValidation":"' + params.INVOICE_VALIDATION + '","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111","locale":"ja_JP"}},' +
                '{"displayname":"MOE DTC O2P Order JP - Customer - Existing","testcasename":"2363224d","description":"MOE DTC O2P Order JP - Customer - Existing","testClass":"com.autodesk.ece.bic.testsuites.MOEOrderFlows","testGroup":"bic-returningUserOdmDtc-moe","testMethod":"validateMoeOdmDtcFlowReturningCustomer","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16023"},"testdata":{"usertype":"existing","password":"","payment":"CREDITCARD","store":"STORE-JP","sku":"default:1","email":"","sapValidation":"' + params.INVOICE_VALIDATION + '","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111","locale":"ja_JP"}},' +
                '{"displayname":"BiC order Flex - Japan Konbini","testcasename":"d27c5060","description":"BiC order Flex - Japan Konbini","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-flexorder-new","testMethod":"validateFlexOrderNewCart","parameters":{"application":"ece","jiraTestFolderId":"8305","jiraId":"APLR2PMO-16025"},"testdata":{"usertype":"new","password":"","payment":"KONBINI","store":"STORE-JP","sku":"default:1","email":"","locale":"ja_JP","store_type":"FAMILY_MART","address":"Autodesk@2-8-1 Nishi Shinjuku@Shinjuku Ku@163-8001@03-5321-1111","sapValidation":"' + params.INVOICE_VALIDATION + '"}}' +
                '],"workstreamname":"dclecjt"}'
        println("Starting Testing Hub API Call - flex - All")
        if (serviceBuildHelper.ambassadorService.callTestingHubApi(testingHubInputMap)) {
            println('Testing Hub API called successfully - flex - All')
