        ...
        stage ('Nightly Regression') {
            ...
            steps {
                ...
                script {
                    ...
                    testingHubInputMap.testingHubApiPayload = '{"env":"STG","executionname":"Order Service - Orders","notificationemail":["sumant.manda@autodesk.com"],"testcases":[' +
                ...
                script {
                    ...
                    testingHubInputMap.testingHubApiPayload = '{"env":"STG","executionname":"Order Service - Account Portal","notificationemail":["sumant.manda@autodesk.com"],"testcases":[' +
