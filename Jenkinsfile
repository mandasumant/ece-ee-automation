...
def triggerApolloR2_1_2(def serviceBuildHelper, String env) {
    ...
    script {
        ...
        testingHubInputMap.testingHubApiPayload = '{"env":" ' + env + ' ","executionname":"Apollo: R2.1.2 on ' + env + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                ...
                '{"displayname":"Q2O SUS - Single Line Item - Annual - AU - LOC","testcasename":"10bb01af","description":"Q2O SUS - Single Line Item - Annual - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual","testMethod":"validateQuoteOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","emailType":"biz","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","isTaxed":"Y","taxId":"11223491505","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"SUS Partial Refund O2P MultiLine Direct Order","testcasename":"d3eb65f3","description":"SUS Partial Refund O2P MultiLine Direct Order","testClass":"com.autodesk.ece.bic.testsuites.DirectOrder","testGroup":"partial-refund-multiline-order","testMethod":"validatePartialRefundMultilineDirectOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"SUS Direct AU/Cocos - CC","testcasename":"6eb74ce4","description":"SUS O2P Direct","testClass":"com.autodesk.ece.bic.testsuites.DirectOrder","testGroup":"create-direct-order","testMethod":"createDirectOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@RR6H FJ6@West Island@6799@397202088@Cocos (Keeling) Islands","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Single Line Item - Annual - AU/Christmas - CC","testcasename":"10bb01af","description":"Q2O SUS - Single Line Item - Annual - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual","testMethod":"validateQuoteOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"False","agentCSN":"5070132993","agentEmail":"partneruser_da_int_5070132993@letscheck.email","address":"AutodeskAU@33 Phosphate Hill Road@Christmas Island@6798@397202088@Christmas Island","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Single Line Item - Annual - AU/Norfolk - CC","testcasename":"10bb01af","description":"Q2O SUS - Single Line Item - Annual - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual","testMethod":"validateQuoteOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"False","agentCSN":"5070132993","agentEmail":"partneruser_da_int_5070132993@letscheck.email","address":"AutodeskAU@53 Hemus Road@Burnt Pine@2899@397202088@Norfolk Island","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Single Line Item - Annual - AU/Cocos - CC","testcasename":"10bb01af","description":"Q2O SUS - Single Line Item - Annual - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual","testMethod":"validateQuoteOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"False","agentCSN":"5070132993","agentEmail":"partneruser_da_int_5070132993@letscheck.email","address":"AutodeskAU@RR6H FJ6@West Island Shire of Cocos@6799@397202088@Cocos (Keeling) Islands","timezone":"Australia/Sydney"}},' +
