          ...
          steps {
              ...
              script {
                  ...
                  testingHubInputMap.testingHubApiPayload = '{"env":"STG","executionname":"Appolo UAT - GUAC Orders","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                                                              ...
                                                              '{"displayname":"BiC Native Order IT(it_IS)","testcasename":"validateBicNativeOrder","description":"BiC Native Order IT(it_IT)","os":"windows","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-nativeorder","testMethod":"validateBicNativeOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CREDITCARD","store":"STORE-IT","sku":"default:1","email":"","locale":"it_IT"},"notsupportedenv":[],"wiki":""},' +
                                                              '{"displayname":"BiC Native Order NO(no_NO)","testcasename":"validateBicNativeOrder","description":"BiC Native Order IT(it_IT)","os":"windows","testClass":"com.autodesk.ece.bic.testsuites.BICOrderCreation","testGroup":"bic-nativeorder","testMethod":"validateBicNativeOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CREDITCARD","store":"STORE-NO","sku":"default:1","email":"","locale":"it_IT"},"notsupportedenv":[],"wiki":""},' +
