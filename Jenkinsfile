...
def triggerApolloR2_1_2(def serviceBuildHelper, String env) {
    ...
    script {
        ...
        testingHubInputMap.testingHubApiPayload = '{"env":" ' + env + ' ","executionname":"Apollo: R2.1.2 on ' + env + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                ...
                '{"displayname":"Q2O FLEX - Single Line Item - AU - CC","testcasename":"8e83688b","description":"Q2O FLEX - Single Line Item - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-flex","testMethod":"validateQuoteOrderFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O FLEX - Single Line Item - AU - PAYPAL","testcasename":"6751d047","description":"Q2O FLEX - Single Line Item - AU - PAYPAL","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-flex","testMethod":"validateQuoteOrderFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"PAYPAL","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O FLEX - Single Line Item - AU - LOC","testcasename":"8e83688b","description":"Q2O FLEX - Single Line Item - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-flex","testMethod":"validateQuoteOrderFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"LOC","emailType":"biz","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and Flex - AU - CC","testcasename":"c26311ff","description":"Q2O SUS - Multi Line Item - Annual and Flex - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-flex","testMethod":"validateQuoteOrderAnnualFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and Flex - AU - LOC","testcasename":"c26311ff","description":"Q2O SUS - Multi Line Item - Annual and Flex - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-flex","testMethod":"validateQuoteOrderAnnualFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"LOC","emailType":"biz","emailType":"biz","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual, Flex, MYAB and Premium Offer AU - CC","testcasename":"57223646","description":"Q2O SUS - Multi Line Item - Annual, Flex, MYAB and Premium Offer AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-flex-myab-premium","testMethod":"validateQuoteOrderAnnualMYABFLEXPremium","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual, Flex, MYAB and Premium Offer AU - LOC","testcasename":"57223646","description":"Q2O SUS - Multi Line Item - Annual, Flex, MYAB and Premium Offer AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-flex-myab-premium","testMethod":"validateQuoteOrderAnnualMYABFLEXPremium","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","quantity1":"3000","payment":"LOC","emailType":"biz","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Refund Direct SUS Multi Line Item - Annual LOC","testcasename":"3a51f9cb","description":"Refund Direct Annual LOC","testClass":"com.autodesk.ece.bic.testsuites.DirectOrder","testGroup":"refund-multiline-order-loc","testMethod":"createRefundLOCMultilineDirectOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney","agentCSN":"5112991506","agentEmail":"partneruser_da_int_5112991506@letscheck.email"}},' +
                '{"displayname":"Renew Q2O SUS CC","testcasename":"6b2be18d","description":"Renew Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"renew-quote-order-annual","testMethod":"validateRenewQuoteOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Terminate Q2O SUS CC","testcasename":"77e82e12","description":"Terminate Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-subscription-status","testMethod":"validateQuoteOrderSubscriptionStates","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","subscriptionStatus":"TERMINATED","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Suspend Q2O SUS CC","testcasename":"77e82e12","description":"Suspend Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-subscription-status","testMethod":"validateQuoteOrderSubscriptionStates","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","subscriptionStatus":"SUSPENDED","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Expire Q2O SUS CC","testcasename":"77e82e12","description":"Expire Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-subscription-status","testMethod":"validateQuoteOrderSubscriptionStates","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","subscriptionStatus":"EXPIRED","store":"STORE-AUS","locale":"en_AU","pullFromDataStore":"True","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
