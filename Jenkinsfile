...
def triggerApolloR2_1_2(def serviceBuildHelper, String env) {
    ...
    script {
        ...
        testingHubInputMap.testingHubApiPayload = '{"env":" ' + env + ' ","executionname":"Apollo: R2.1.2 on ' + env + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                ...
                '{"displayname":"Q2O FLEX - Single Line Item - AU - CC","testcasename":"8e83688b","description":"Q2O FLEX - Single Line Item - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-flex","testMethod":"validateQuoteOrderFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O FLEX - Single Line Item - AU - PAYPAL","testcasename":"8e83688b","description":"Q2O FLEX - Single Line Item - AU - PAYPAL","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-flex","testMethod":"validateQuoteOrderFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"PAYPAL","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O FLEX - Single Line Item - AU - LOC","testcasename":"8e83688b","description":"Q2O FLEX - Single Line Item - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-flex","testMethod":"validateQuoteOrderFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Q2O SUS - Single Line Item - MYAB - AU - PAYPAL","testcasename":"6308c0bb","description":"Q2O SUS - Single Line Item - MYAB - AU - PAYPAL","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-myab","testMethod":"validateQuoteOrderMYAB","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"PAYPAL","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Q2O SUS - Single Line Item - Premium - AU - LOC","testcasename":"e3ecfeb4","description":"Q2O SUS - Single Line Item - Premium - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-premium","testMethod":"validateQuoteOrderPremium","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","sapValidation":"' + params.INVOICE_VALIDATION + '","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Q2O SUS - Single Line Item - Returning User - Same Payment - AU - LOC","testcasename":"67a7eeb8","description":"Q2O SUS - Single Line Item - Returning User - Same Payment - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-returning-user","testMethod":"validateQuoteOrderReturningUser","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","newPaymentType":"LOC","isSamePayer":"true","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Q2O SUS - Single Line Item - Returning User - New Payment - AU - LOC and CC","testcasename":"67a7eeb8","description":"Q2O SUS - Single Line Item - Returning User - Same Payment - AU - LOC and CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-returning-user","testMethod":"validateQuoteOrderReturningUser","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","newPaymentType":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and MYAB - AU - CC","testcasename":"a2afad9d","description":"Q2O SUS - Multi Line Item - Annual and MYAB - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-myab","testMethod":"validateQuoteOrderAnnualMYAB","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and MYAB - AU - PAYPAL","testcasename":"a2afad9d","description":"Q2O SUS - Multi Line Item - Annual and MYAB - AU - PAYPAL","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-myab","testMethod":"validateQuoteOrderAnnualMYAB","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"PAYPAL","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and MYAB - AU - LOC","testcasename":"a2afad9d","description":"Q2O SUS - Multi Line Item - Annual and MYAB - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-myab","testMethod":"validateQuoteOrderAnnualMYAB","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and Flex - AU - CC","testcasename":"c26311ff","description":"Q2O SUS - Multi Line Item - Annual and Flex - AU - CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-flex","testMethod":"validateQuoteOrderAnnualFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Q2O SUS - Multi Line Item - Annual and Flex - AU - LOC","testcasename":"c26311ff","description":"Q2O SUS - Multi Line Item - Annual and Flex - AU - LOC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-annual-flex","testMethod":"validateQuoteOrderAnnualFlex","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"LOC","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"SUS Direct AU - Returning User - Paypal","testcasename":"776f2a25","description":"SUS O2P Direct","testClass":"com.autodesk.ece.bic.testsuites.DirectOrder","testGroup":"returning-user","testMethod":"createReturningUserDirectOrder","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"PAYPAL","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Refund Q2O SUS Single Line Item - Annual CC","testcasename":"27b5eaa9","description":"Refund Q2O Annual CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-refund-annual","testMethod":"validateQuoteRefundOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                ...
                '{"displayname":"Renew Q2O SUS CC","testcasename":"6b2be18d","description":"Renew Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"renew-quote-order-annual","testMethod":"validateRenewQuoteOrderAnnual","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Terminate Q2O SUS CC","testcasename":"77e82e12","description":"Terminate Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-subscription-status","testMethod":"validateQuoteOrderSubscriptionStates","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","subscriptionStatus":"TERMINATED","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Suspend Q2O SUS CC","testcasename":"77e82e12","description":"Suspend Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-subscription-status","testMethod":"validateQuoteOrderSubscriptionStates","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","subscriptionStatus":"SUSPENDED","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}},' +
                '{"displayname":"Expire Q2O SUS CC","testcasename":"77e82e12","description":"Expire Q2O SUS CC","testClass":"com.autodesk.ece.bic.testsuites.QuoteOrder","testGroup":"quote-order-subscription-status","testMethod":"validateQuoteOrderSubscriptionStates","parameters":{"application":"ece"},"testdata":{"usertype":"new","email":"","password":"","sku":"default:1","payment":"CREDITCARD","subscriptionStatus":"EXPIRED","store":"STORE-AUS","locale":"en_AU","address":"AutodeskAU@131 Abala Rd@Marrara@0812@397202088@Australia@NT","timezone":"Australia/Sydney"}}' +
                '],"workstreamname":"dclecjt"}'
    ...
    script {
        if (env == "STG") {
            ...
            testingHubInputMap.testingHubApiPayload = '{"env":"' + env + '","executionname":"CLT Regression on ' + env + '","executionid":"' + execution_id + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                    ...
                    '{"displayname":"MOAB - Reseller  Pay invoices with Cash & CM - US","testcasename":"26497eda","description":"MOAB - Reseller Pay invoices with Cash & CM- US","testClass":"com.autodesk.ece.bic.testsuites.MOABOrder","testGroup":"moab-payinvoice","testMethod":"validateMOABPayInvoice","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CASH","store":"STORE-NAMER","purchaserEmail":"Reseller_US_DCLE_i4lJmK@letscheck.pw","csn":"5500971254","applyCM":"Y","sku":"default:1","email":"","locale":"en_US"}},' +
                    '{"displayname":"MOAB - Reseller  Pay invoices with BACS - UK","testcasename":"26497eda","description":"MOAB - Reseller Pay invoices with BACS- UK","testClass":"com.autodesk.ece.bic.testsuites.MOABOrder","testGroup":"moab-payinvoice","testMethod":"validateMOABPayInvoice","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"BACS","store":"STORE-UK","purchaserEmail":"Reseller_UK_DCLE_2ZgMkv@letscheck.pw","csn":"5500971062","sku":"default:1","email":"","locale":"en_GB"}},' +
            ...
            testingHubInputMap.testingHubApiPayload = '{"env":"' + env + '","executionname":"CLT Regression on ' + env + '","executionid":"' + execution_id + '","notificationemail":["ece.dcle.platform.automation@autodesk.com"],"testcases":[' +
                    ...
                    '{"displayname":"MOAB - Reseller  Pay invoices with Cash & CM - US","testcasename":"26497eda","description":"MOAB - Reseller Pay invoices with Cash & CM- US","testClass":"com.autodesk.ece.bic.testsuites.MOABOrder","testGroup":"moab-payinvoice","testMethod":"validateMOABPayInvoice","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CASH","store":"STORE-NAMER","purchaserEmail":"thpu7OwL5kk97h@letscheck.pw","csn":"5501308785","applyCM":"Y","sku":"default:1","email":"","locale":"en_US"}},' +
                    '{"displayname":"MOAB - Reseller  Pay invoices with BACS - UK","testcasename":"26497eda","description":"MOAB - Reseller Pay invoices with BACS- UK","testClass":"com.autodesk.ece.bic.testsuites.MOABOrder","testGroup":"moab-payinvoice","testMethod":"validateMOABPayInvoice","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"BACS","store":"STORE-UK","purchaserEmail":"thpumurxsSnXxe@letscheck.pw","csn":"5501308790","sku":"default:1","email":"","locale":"en_GB"}},' +
...
def triggerAnalytics(def serviceBuildHelper, String env) {
    ...
    script {
        ...
        testingHubInputMap.testingHubApiEndpoint = 'https://api.testinghub.autodesk.com/hosting/v1/project/accountportal/testcase'
        testingHubInputMap.testingHubApiPayload = '{"env":"' + env + '","executionname":"Analytics Regression on ' + env + '","executionid":"' + execution_id + '","notificationemail":["ece.dcle.platform.automation@autodesk.com","abhijit.rajurkar@autodesk.com","adam.hill@autodesk.com"],"testcases":[' +
                '{"displayname":"MOAB - Reseller  Pay invoices with Cash & CM - US","testcasename":"26497eda","description":"MOAB - Reseller Pay invoices with Cash & CM - US","testClass":"com.autodesk.ece.bic.testsuites.MOABOrder","testGroup":"moab-payinvoice","testMethod":"validateMOABPayInvoice","parameters":{"application":"ece"},"testdata":{"usertype":"new","password":"","payment":"CASH","store":"STORE-NAMER","purchaserEmail":"Reseller_US_DCLE_i4lJmK@letscheck.pw","csn":"5500971254","applyCM":"Y","sku":"default:1","applyAnalytics":"True","email":"","locale":"en_US"}}' +
                '],"workstreamname":"dclecjt"}'
        println("Starting Testing Hub API Call - accountportal")
        if (serviceBuildHelper.ambassadorService.callTestingHubApi(testingHubInputMap)) {
